...
root = Tk()
root.title("Calculator by IvanDRG")
...
def button_equal():
    if math == "addition":
        result = int(e.get()) + first_number
    elif math == "subtraction":
        result = first_number - int(e.get())
    elif math == "multiplication":
        result = first_number * int(e.get())
    elif math == "division":
        result = int(first_number / int(e.get()))
    e.delete(0, END)
    e.insert(0, result)
